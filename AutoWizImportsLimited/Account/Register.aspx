<%@ Page Title="Register" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="AutoWizImportsLimited.Account.Register" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <div>
        <div class="form-horizontal">
            ...
            <div class="form-group">
                <asp:Label runat="server" AssociatedControlID="DOB" CssClass="col-md-2 control-label">D.O.B</asp:Label>
                <div class="col-md-10">
