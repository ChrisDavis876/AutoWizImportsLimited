...
using System.Web;
using AutoWizImportsLimited;
using AutoWizImportsLimited.Models;
...
public class NVPAPICaller
{
  ...
  public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
  {
    ...
    using (AutoWizImportsLimited.Logic.ShoppingCartActions myCartOrders = new AutoWizImportsLimited.Logic.ShoppingCartActions())
    {
  ...
  public string HttpCall(string NvpRequest)
  {
    ...
    {
      // Log the exception.
      AutoWizImportsLimited.Logic.ExceptionUtility.LogException(e, "HttpCall in PayPalFunction.cs");
    }
